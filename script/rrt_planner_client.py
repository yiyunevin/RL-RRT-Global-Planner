"""
2022/08/03 by Evin Hsu
--------------------------------------------
 Global Planner (B-RRT*) API
--------------------------------------------
>> Given Start & Goal --> Get Intermidiate Points
>> Get Map Information
>> Get Obbupied Value
>> RViz Visualization
"""
...
class GlobalClient:
    ...
    ## -------------------------
        ...
        self.mk_inter_pub = rospy.Publisher('/marker_inter', Marker, queue_size=10) # bug
        self.mk_inter = Marker()
        self.mk_inter_color = [0., 1., 1.]
        self.mk_path_pub = rospy.Publisher('/marker_path', Marker, queue_size=10)   # bug
        self.mk_path = Marker()
